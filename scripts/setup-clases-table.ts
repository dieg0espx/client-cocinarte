...
async function createClasesTable() {
  try {
    ...
    if (!response.ok) {
      ...
      // Alternative: Create the table by inserting a dummy record and then deleting it
      ...
      console.log('3. Run the contents of scripts/create-clases-table.sql');
      return;
    }
    ...
    console.log('1. Go to your Supabase dashboard');
    console.log('2. Navigate to SQL Editor');
    console.log('3. Copy and paste the contents of scripts/create-clases-table.sql');
